          ...
          <PageWrapper>
            <div className="mx-auto flex max-w-sm flex-col justify-between">
              ...
              <p className="pb-6 font-semibold text-[#ffffffb3]">
                ...
                boilerplate that includes all you need to build amazing
                projects. No need to spend time on configuring the basic needs
                of a project. I did that for you - Created by{" "}
                <a
